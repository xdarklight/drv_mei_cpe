...
#define MEI_GET_ENTITY_FROM_DEVNUM(device_num) (device_num / MEI_MAX_DFE_INSTANCE_PER_ENTITY)

/** get the relative channel num on the entity from the given channel */
#define MEI_GET_REL_CH_FROM_DEVNUM(device_num) (device_num % MEI_MAX_DFE_INSTANCE_PER_ENTITY)
...
struct MEIx_cntrl_s
{
   ...
   */
   ...
   MEI_MEI_DEV_CNTRL_T *pMeiDevCntrl[MEI_MAX_MEI_IF_PER_DEVICE];

   /** xDSL chip interface's control structure */
   MEI_DEV_T           *MeiDevice[MEI_MAX_DFE_INSTANCE_PER_ENTITY];
...
/** devices */
extern MEIX_CNTRL_T* MEIX_Cntrl[MEI_MAX_DFEX_ENTITIES];
